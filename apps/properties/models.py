...
class Property(CommonUUIDModel):
    ...
    title = models.CharField(
        max_length=200, default="3 bedroom flat", verbose_name=_("Property Name")
    )
    slug = AutoSlugField(populate_from="title", unique=True, always_update=True)
    hosted_by = models.ForeignKey(
        User, related_name="host_agent", on_delete=models.DO_NOTHING
    )
    description = models.TextField(
        verbose_name=_("Property Description"), default="tell us about the property"
    )
    ref_code = models.CharField(
        max_length=10, unique=True, verbose_name=_("Reference Code"), blank=True
    )
    postal_code = models.CharField(
        max_length=10, default="120003", verbose_name=_("Postal Code")
    )
    ...
    street_address = models.CharField(
        max_length=255, verbose_name=_("Street Address"), default="allen avenue, LG."
    )
    ...
    num_of_bathrooms = models.IntegerField(
        verbose_name=_("Number of Bathroom"), default=0
    )
    amenities = models.CharField(
        max_length=200,
        verbose_name=_("Other things in the property"),
        default="swimming pool, kitchen, gym",
    )
    advert_type = models.CharField(
        max_length=20,
        verbose_name=_("Advert Type"),
        choices=AdvertType.choices,
        default=AdvertType.FOR_SHORT_STAY,
    )
    property_type = models.CharField(
        max_length=20,
        verbose_name=_("What Type of Property"),
        choices=PropertyType.choices,
        default=PropertyType.APARTMENT,
    )
    cover_photo = models.ImageField(
        verbose_name=_("Property Image"), default="/house_sample.jpg"
    )
