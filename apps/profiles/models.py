...
class HostAgent(CommonUUIDModel):
    brand_name = models.CharField(max_length=200, verbose_name=_("Host Business Name"), unique=True)
    profile=models.ForeignKey(Profile, related_name="agent", on_delete=models.DO_NOTHING)
    license = models.CharField(verbose_name=_("Real Estate License"), max_length=30, blank=True, null=True)
